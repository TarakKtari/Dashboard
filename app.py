...
from user.routes import (
    user_bp, init_socketio, delete_expired_positions,
    update_order_interbank_and_benchmark_rates, update_interbank_rates_db_logic,
)
...
def get_vix_data():
    vix = yf.Ticker("^VIX")
    hist = vix.history(period="1d", interval="5m")  # 5-minute intervals for today
